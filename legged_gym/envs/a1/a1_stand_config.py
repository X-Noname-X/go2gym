...
class A1StandCfg(LeggedRobotCfg):
    ...
    class rewards(LeggedRobotCfg.rewards):
        base_height_target = 0.42   # A1 站立目标高度
...
class A1StandCfgPPO(LeggedRobotCfgPPO):
    class algorithm(LeggedRobotCfgPPO.algorithm):
        entropy_coef = 0.01
    class runner(LeggedRobotCfgPPO.runner):
        experiment_name = 'stand_a1'
        max_iterations = 500          # 站立比行走收敛快
